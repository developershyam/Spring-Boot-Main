		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<ul class="nav navbar-nav">
					<li id="homeTab" class=""><a href="${pageContext.request.contextPath}/welcome"><span class="glyphicon glyphicon-home"
							style="font-size: 18px; padding-right: 8px"></span> Home</a></li>
					<li id="employeeTab"><a href="${pageContext.request.contextPath}/employees"><span class="glyphicon glyphicon-user"
