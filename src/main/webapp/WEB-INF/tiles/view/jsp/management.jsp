...
var firstURL='${pageContext.request.contextPath}/management/autoconfig';
</script>
<script src="${pageContext.request.contextPath}/resources/js/api/json-formatter.js"></script>
